...
function App() {
  ...
  <div className="bg-gradient-to-t from-violet-200 to-fuchsia-500 h-screen xl:text-xl">
    ...
    <div className="flex flex-col items-center mt-40 justify-center text-center xl:mt-50">
  ...
  <p className="mt-2">A web developer or freelancer that make your site go to online and public </p>
     ...
     <a className="px-5 py-2 bg-green-500 text-white inline"> Contact </a>
     <a className="px-5 py-2 bg-green-500 text-white inline"> Info </a>
     </div>

         <div className="text-white text-left mt-20 italic xl:text-lg">
